  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-2 gap-4 md:grid-cols-5 mt-4 items-center'>
        ...
        {photoUrl && (
          <div
            className={`flex flex-col items-center gap-2 p-1 rounded-full text-center text-white transition-all duration-300 cursor-pointer ${
        ...
        {showUploadPhoto ? (
          ...
          <div
            className='flex flex-col items-center justify-center hover:bg-stone-100 h-full rounded-full cursor-pointer border'
